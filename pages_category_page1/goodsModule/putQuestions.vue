    ...
    <view class="questionCent">
      ...
      <view class="anonymous">
		  <view class="flex-row-plus flex-items" @click="changeCheck">
			 <image v-if="anonymous == true" src="../../static/images/select-active.png" class="cart-select-img"></image> 
			 <image v-else src="../../static/images/select-empty.png" class="cart-select-img"></image>
			 <label>匿名提问</label>
		  </view>
      </view>
    </view>
