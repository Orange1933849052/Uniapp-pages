		...
		<u-mask :show="show" z-index="10000">
			<view class="warp">
				<view class="rect" @tap.stop>
					<!-- 关闭按钮 -->
					<image @click="showcos" src="../../static/img/guanbi@2x.png" class="guanbi" mode=""></image>
					<!-- 内容 -->
					<view>
					...
					<view style="padding: 30rpx;">
						...
						<view class="user">
							...
							<view style="color: #FF7800;font-size: 24rpx;flex: 1; text-align: right;line-height: 45rpx;" v-if="listitem.invitationCode">
						...
						<view style="display: flex;margin-top: 40upx;">
							...
							<view style="margin-left: 60rpx;" v-if="listitem.ifLogo">
								...
								<view class="qrimg-i" @click="saveQrcode">
									<tki-qrcode :show="true" cid="qrcode2" ref="qrcode" :val="erweima" :size="size" :onval="onval" :loadMake="loadMake" :usingComponents="true" />
								</view>
							</view>
						</view>
					</view>
          ...
          <button open-type="share" >
            <view @click="WXfenx" style="flex: 1;text-align: center;display: flex;">
              <view style="margin-left: 120rpx;">
                <image src="../../static/img/weixin@2x.png" mode=""></image>
              </view>
...
<script>
	...
	export default {
		...
		onLoad: function(options) {
			...
			// this.erweima = 'https://ceres.zkthink.com/pages_category_page1/store/index?storeId='+this.shopId,
			this.erweima = 'https://ceres.zkthink.com/pages/tabbar/index/index'
