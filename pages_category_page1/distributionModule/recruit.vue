<template>
	<view class="container">
		...
		<!-- 填写信息弹窗 -->
		<u-popup class="informationShow-box" v-model="informationShowFalg" mode="center" border-radius="14">
			<view class="flex-items flex-column informationShow-centent">
				...
				<view class="flex-items flex-row mar-top-30">
					...
					<input class="recruitIphone mar-left-20 fs26" type="number" v-model="mobile"/>
				</view>
	...
	.container {
		.topBackImg {
			...
			.content {
				...
				.topColor {
					height: 60upx;
					background-image: linear-gradient(to bottom, #FF8D13 10%, #FFFFFF 100%);
					opacity: 0.5;
				}
