		...
		<view class="content" style="padding-bottom:200upx;">
			...
			<view class="afterSale-select-box">
				<view class="item" @click="openStatusSelect">
					...
					<view class="r-box" v-model="ReturnMoneyQuery.goodsState" v-if="ReturnMoneyQuery.goodsState == 1">
						<text>未收到货</text>
						<image src="../../static/images/arrow-right.png" class="r"></image>
					</view>
			...
			<view class="afterSale-select-box mt20">
				...
				<view class="mar-left-10 mar-top-10">
					<u-upload  max-count="4" :action="action" ref="uUpload" :header="headerToken" :form-data="formData"></u-upload>
				</view>
			</view>
				...
				<view class="afterSale-status-box">
					...
					<view class="item-box">
						<view class="item" @click="ReturnMoneyQuery.goodsState = 1">
							...
							<image src="../../static/images/select-active.png" v-if="ReturnMoneyQuery.goodsState == 1" class="status-select-img"></image>
							<image src="../../static/images/select-empty.png" v-else class="status-select-img"></image>
						</view>
						<view class="item" @click="ReturnMoneyQuery.goodsState = 2">
							<text class="status-select-title">已收到货</text>
							<image src="../../static/images/select-active.png" v-if="ReturnMoneyQuery.goodsState == 2" class="status-select-img"></image>
							<image src="../../static/images/select-empty.png" v-else class="status-select-img"></image>
						</view>
					</view>
				...
				<view class="afterSale-status-box" scroll-y style="height:60%;">
					...
					<view class="item-box">
						<view class="item" @click="returnReasonTap(item,index)" v-for="(item,index) in liyouData" :key="index">
							...
							<image src="../../static/images/select-active.png" v-if="ReturnMoneyQuery.returnReason == index" class="status-select-img"></image>
							<image src="../../static/images/select-empty.png" v-else class="status-select-img"></image>
						</view>
					</view>
	...
	export default {
		data() {
			return {
				...
				action:'https://ceres.zkthink.com/api/file/upload',
				formData:{'folderId': -1},
