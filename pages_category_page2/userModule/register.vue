	...
	<view class="container flex-items-plus flex-column">
		...
		<view>
			<view class="iphoneNum-box flex-row-plus flex-items">
				<view style="width: 136rpx;margin-left: 24upx;">
					手机号
				</view>
				<view>
					<input v-model="phone" class="iphoneNum-inputbox" placeholder-class="iphoneNum-input" type="number" placeholder="请输入您的手机号" />
				</view>
			</view>
			<view class="flex-row-plus mar-top-20">
				<view class="code-box">
					...
					<view>
						<input v-model="RegisterQuery.code" class="codeNum-inputbox" placeholder-class="codeNum-input" placeholder="请输入验证码" />
					</view>
				</view>
		...
		<view class="mar-top-100">
			<label class="font-color-999">注册即代表同意</label>
			<label class="font-color-47A7EE" @click="protocol">《cereshop》商城用户协议</label>
		</view>
		<view class="registerBut" @click="onregister">注册</view>
		<view class="flex-row-plus mar-top-30">
			<label class="font-color-FF7800">已有账号，</label>
