	...
	<view class="footprint-box">
		<view v-if="footprintList.length>0">
					...
					<view class="">
						<view @click.stop="toGoodsDetails(item.productId,item.shopId,item.skuId)" class="item u-border-bottom wid flex-row-plus flex-items">
							<view v-show="allCheckShow">
								<image v-if="item.selected == 1" @click.stop="footItemSel(index,findex,0)" src="../../static/images/select-active.png" class="cart-select-img"></image>
								<image v-else @click.stop="footItemSel(index,findex,1)" src="../../static/images/select-empty.png" class="cart-select-img"></image>
							</view>
			...
			<view v-show="allCheckShow" class="allcheck-box flex-row-plus flex-sp-between flex-items">
				<view class="left">
					<image v-if="isAllCheck" src="../../static/images/select-active.png" class="cart-select-img" @click="allSel(0)"></image>
		...
		<view v-else class="mar-top-60 empty-box" @click="goToIndex">
			<image class="footprint-empty" src="../../static/images/footprint-empty.png"></image>
