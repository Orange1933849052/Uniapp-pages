<template>
  <div class="hom-pro-list warp" :class="'terminal'+terminal" v-if="firstProduct">
    <div class="title" :class="'text-align-'+componentContent.textAlign">
      ...
      <a class="btn-all" @click="goSeckills(shopId!==0 && {shopId:shopId,id:componentContent.shopSeckillId})">查看全部<i class="iconfont icon-arrow-right"></i></a>
    ...
    <div v-if="(componentContent.shopSeckillId && skillsInfo && count.length > 0) || componentContent.productData.productIdList !==0">
      ...
      <div class="listLeft">
        ...
        <div class="bgBox">
          ...
          <div class="timeBox">
           ...
           <button @click="goSeckills(shopId!==0 && {shopId:shopId,id:componentContent.shopSeckillId})">查看全部></button>
        </div>
      </div>
      <div class="listRight">
        <div class="listItem" v-for='it in skillsInfo.products' :key='it.productId' @click="goGoods(it)">
          <div class="imgBox">
    ...
    <div class="mobileList" v-else>
      <div class="topList mItem"  @click="goGoods(firstProduct)" v-if='firstProduct'>
        <div class="topImgBg">
          <img :src="firstProduct.image" alt="">
          <div class="leftText">
            <image class="img" src="../../../static/assets/images/icon-spike.png"></image>
            <span>秒杀活动</span>
          </div>
        ...
        <div class="itemInfo">
          <div class="itemTit">
            ...
            <span v-if="firstProduct.limitNumber && firstProduct.limitNumber>0">剩余{{firstProduct.stockNumber}}件</span>
          </div>
          <div class="Price">
      ...
      <div class="listBox">
        <div class="mItem" v-for='it in appProducts' :key='it.productId' @click="goGoods(it)">
          <div class="topImgBg">
            <img :src="it.image" alt="">
            <div class="leftText">
              <image class="img" src="../../../static/assets/images/icon-spike.png"></image>
  ...
  methods: {
    getData() {
      ...
      if(this.typeId === 1){
        ...
        //   title: '加载中...'
        // })
        NET.request1(`${API.getProducts}?page=1&pageSize=99&type=2&ids=${_.componentContent.productData.productIdList}`, null, 'GET').then(res => {
        ...
        if(_.componentContent.shopSeckillId){
          ...
          //   title: '加载中...'
          // })
          NET.request1(`${API.getSeckills}?shopId=${_.shopId}&ids=${_.componentContent.shopSeckillId}`, null, 'GET').then(res => {
